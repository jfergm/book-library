...
class SectionRequestValidationTest {
  ...
  void shouldBeValidWithAllValues() {
    SectionRequest request = new SectionRequest(1L, "code", "label", "desc");

    Set<ConstraintViolation<SectionRequest>> violations = validator.validate(request);
  ...
  void shouldNotBeValidWithInvalidFields(Long floorId, String code, String label, String expectedProperty) {
    SectionRequest request = new SectionRequest(floorId, code, label, "desc");
